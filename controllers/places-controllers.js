...
const deletePlace = async (req, res, next) => {
  ...
  try {
    ...
    const error = new HttpError(
      "Something went wrong, could not delete a place 1",
      500
    );
  ...
  try {
    ...
    const error = new HttpError(
      "Something went wrong, could not delete a place 2",
      500
    );
...
const deletePlaces = async (req, res, next) => {
  ...
  try {
    ...
    const error = new HttpError(
      "Something went wrong, could not delete places 1",
      500
    );
  ...
  try {
    ...
    const error = new HttpError(
      "Something went wrong, could not delete places 2",
      500
    );
