...
module.exports=(req,res,next)=>{
    ...
    if(req.method === "OPTIONS"){ //sometime the request type is OPTIONS even though you send a POST request...this is a type that checks if the server accepts certain options. 
    ...
    } catch(err){ //this happens if there isn't any authorization header
